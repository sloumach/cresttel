...
<body>
 ...
 <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0 px-4 px-lg-5">
   ...
   <div class="container py-5">            <h1  class="display-3 text-white mb-3 animated slideInDown" style="color: #1591ea;">About Us - Cresttel, Leading Construction Company in San Diego</h1>
        ...
        <div class="content clearfix">
            <div class="cube-container">
                <div class="photo-cube">
                    ...
                    <div class="back photo-desc">
                        ...
                        <p> Our team of experts will meet with you to discuss your vision, requirements, and goals for the project, ensuring we understand your needs and preferences.</p>
            ...
            <div class="cube-container">
                <div class="photo-cube">
                    ...
                    <div class="back photo-desc">
                        <h3>2.Feasibility</h3>
                        <p> We perform a detailed feasibility study to evaluate your project's practicality, covering site analysis, cost estimates, and potential challenges.</p>
                    </div>
            ...
            <div class="cube-container">
                <div class="photo-cube">
                    ...
                    <div class="back photo-desc">
                        <h3>3. Financing</h3>
                        <p> We help you secure financing, offering budget planning and funding strategy guidance to ensure your project's financial viability.</p>
            ...
            <div class="cube-container">
                <div class="photo-cube">
                    ...
                    <div class="back photo-desc">
                        ...
                        <p>Our architects and engineers create detailed plans, while our specialists handle the permitting process to secure construction approvals.</p>
            ...
            <div class="cube-container">
                <div class="photo-cube">
                    ...
                    <div class="back photo-desc">
                        ...
                        <p>Description: We provide interior design services, assisting with the selection of materials, finishes, and furnishings to match your vision and enhance your project's aesthetic.</p>
                        
                    </div>
                    <img class="left" src="img/45.jpg" alt="">
                    <img class="right" src="img/riverfront-park-home-office-den-denver-colorado-nancy-sanford-inc-img~2ad1ed9d0ed07158_3365-1-7c17966-w360-h360-b0-p0.webp" alt="">
        ...
        <div class="content clearfix">
            <div class="cube-container">
                <div class="photo-cube">
                    ...
                    <div class="back photo-desc">
                        ...
                        <p>We finalize permits and contracts, ensuring compliance with local regulations and establishing the legal framework for the project.</p>
            ...
            <div class="cube-container">
                <div class="photo-cube">
                    ...
                    <div class="back photo-desc">
                        <h3>7. Fabricate</h3>
                        <p>Description: Our skilled craftsmen meticulously fabricate project components to the highest quality and precision standards.</p>
            ...
            <div class="cube-container">
                <div class="photo-cube">
                    ...
                    <div class="back photo-desc">
                        <h3>8. Deliver</h3>
                        <p>Description: We coordinate the delivery and installation of all elements, ensuring timely and efficient project completion, ready for occupancy or use.</p>
            ...
            <div class="row g-0 mx-lg-0">
                <div class="col-lg-6 ps-lg-0" style="min-height: 400px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute img-fluid w-100 h-100" src="img/IMG_5389-1.jpg" style="object-fit: cover;" alt="">
                    </div>
                </div>
                <div class="col-lg-6 about-text py-5 wow fadeIn" data-wow-delay="0.5s">
                    <div class="p-lg-5 pe-lg-0">
                        ...
                        <p class="mb-4 pb-2" style="font-size: larger;color: #333333;" >“At Cresttel, we are dedicated to turning your construction dreams into reality. With a commitment to quality craftsmanship and timely delivery, our team of experts works closely with you to ensure every detail of your project is executed to perfection. Whether you’re looking to build a new home, renovate an existing space, or undertake a commercial project, we bring your vision to life with precision and care. Contact us today to get a personalized quote and start building your future with us.”</p>
