...
<div class="slider">
    ...
    <div class="list">
        <div class="item active">
            <img src="img/service img/31.jpg" alt="Wooden garden fence with vibrant flowers and lush green lawn under a clear blue sky - Cresttel Fencing Services">
            <div class="content">
                <p>Service</p>
                <h2>Fence</h2>
                <p>
        ...
        <div class="item">
            <img src="img/ADU_img/blog-2.jpg" alt="Modern backyard office with sleek exterior design, wooden accents, large windows, and landscaped garden - Cresttel construction and renovation services.">
            <div class="content">
                <p>Service</p>
                <h2>ADU</h2>
                <p>
        ...
        <div class="item">
            <img src="img/service img/ser com.jpg" alt="Modern commercial building with American flag at sunset, featuring sleek design and parking accessibility - Cresttel Commercial Services">
            <div class="content">
                <p>Service</p>
                <h2>Commercial</h2>
                <p>
        ...
        <div class="item">
            <img src="img/service img/ser mdu.jpg" alt="Modern building exterior with sleek design, stone facade, and geometric architecture under clear blue sky - Cresttel Services">
            <div class="content">
                <p>Service</p>
                <h2>MDU</h2>
                <p>
