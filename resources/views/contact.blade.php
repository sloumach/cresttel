 ...
 @include('navbar')
    ...
    <div class="container-fluid page-header py-5">
        <div class="container py-5">
            <h1 class="display-3 text-white mb-3 animated slideInDown">Get in Touch with us for Residential & Commercial Construction Services </h1>
            ...
            <div class="row g-0 mx-lg-0">
                ...
                <div class="col-lg-6 quote-text py-5 wow fadeIn" data-wow-delay="0.5s">
                    <div class="p-lg-5 pe-lg-0">
                        <h2 class="display-5 mb-5"><span style="color: #ffffff;">Get in Touch with us for Residential & Commercial Construction Services </span></h2>
                        <p style="font-size: 130%;text-align: center;" class="mb-4 pb-2">
                            We believe in establishing strong relationships with our clients open and consistent dialogue. Whether you
                            have question, specific requirements, or special request, we’re here to assist you. Feel free to contact us
...
<div class="container-fluid px-0">
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3174.6043386906284!2d-116.95677548469295!3d32.8057198809606!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x80d9533e7ddf22cf%3A0x45967470da9a6de4!2s1662%20N%20Magnolia%20Ave%2C%20El%20Cajon%2C%20CA%2092020%2C%20USA!5e0!3m2!1sen!2sus!4v1697567425423!5m2!1sen!2sus"
        width="100%" 
        height="450" 
        style="border:0;" 
        allowfullscreen="" 
...
<section id="about" class="scrollspy-section padding-xlarge">
    <div class="container">
      ...
      <h2 class="section-title">With <span style="color: #007bff;">Cresttel</span> turning your vision into reality  </h2>
                </div>
            </div>
        ...
        <style>
            .description ul li {
              color: #0783e9; /* Set the text color to #0783e9 */
            }
          </style>
          ...
          <div class="row">
            ...
            <div class="col-md-6 description text-lead">
              <p><strong></strong></p>
              <p style="color: #000000;">Quality Craftsmanship: We believe in delivering nothing but the best. Our skilled professionals are dedicated to ensuring that every detail of your project meets the highest standards.</p>
              <p  style="color: #000000;">Timely Delivery: We understand the importance of deadlines. Our efficient project management ensures that your construction is completed on time, every time.</p>
              <p  style="color: #000000;">Personalized Service: Whether you're building a new home, renovating an existing space, or embarking on a commercial project, we tailor our services to meet your unique needs.</p>
              <p  style="color: #000000;"><strong>Our Process</strong></p>
              <p  style="color: #000000;">From the initial consultation to the final touches, we work hand-in-hand with you to bring your vision to life. Our comprehensive approach includes:</p>
              <ul>
              ...
              <p  style="color: #000000;">Ready to turn your construction dreams into reality? Contact us today for a personalized quote and start building your future with Cresttel. Let's create something extraordinary together!</p>
            </div>
          </div>
