				...
				<div class="col-md-6">
					...
					<div class="testimonial-block">
						...
						<div class="testimonials-inner">
							<q>At Cresttel, we pride ourselves on transforming your construction dreams into tangible realities. Our unwavering commitment to quality craftsmanship and timely delivery sets us apart in the industry. Our team of seasoned experts collaborates closely with you to ensure every aspect of your project is executed flawlessly.</q>
...
.footer a {
    ...
    background: none; /* Remove background effects */
...
.footer a:focus,
.footer a:active {
    color: inherit; /* Maintain the inherited text color */
...
.copyright-text {
    font-size: 0.875rem; /* Matches typical footer option size (14px) */
    color: #6c757d; /* Matches secondary text color in footer */
}
...
.copyright-text a:hover {
    color: #1591ea; /* Link hover color to match footer style */
}
...
.copyright {
    ...
    padding: 20px 0; /* Match padding with footer */
}
...
scrollToTop.addEventListener("click", () => {
 ...
 <style>/* Floating Bubble Style */
  .floating-bubble {
      position: fixed;
      bottom: 80px; /* Slightly above the "scroll to top" arrow */
      right: 20px;
      width: 50px;
      height: 50px;
