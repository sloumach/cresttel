...
<body>
    ...
    <section id="blog-details" class="blog-details">
        <div class="container" data-aos="fade-up">
            <div class="row">
                <h2 class="title">Custom Accessory Dwelling Units ( ADU ) providing Experts Design and Construction
                    Services </h2>
                <!-- Main Blog Content -->
                <div class="col-lg-8">
                        ...
                        <div class="content">
                            ...
                            <ul style="font-size: larger;color: #000000;">
                                <li>Rental property. In California, housing is at a premium. Constructing an ADU for
                                    ...
                                    affordable housing option. In California, you may qualify for a $50,000 forgivable
                                    loan if you commit to renting the space to a low-income tenant for three years</li>
                                <li>Increase the value of your home. Building an ADU offers an excellent return on
                                    investment even if you do not rent out the space. For a relatively minor initial
                                    investment, you can significantly increase the value of your home, particularly if
                                    you add a detached ADU.</li>
                                <li>Extend your living space. ADUs can make your existing residence more spacious and
                                    comfortable. If you have family members who you’d like to keep close yet offer
                                    privacy, an ADU is an excellent option. Though it must have the required amenities
                                    for a habitable dwelling, you could also use it as an entertainment room or home
                                    gym.</li>
