...
<head>
    <link rel="canonical" href="https://cresttel.net/{{ route('mduBlog3') }}">
    <meta charset="utf-8">
    <meta charset="UTF-8">
  ...
  <div class="content mt-4">
    ...
    <p></p>
            ...
            <h3>Overview of MDU Types  :</h3>
              ...
              <a style="margin-left: 30%;margin-top: 10%;" href="{{ route('mdu') }}"  class="btn btn-primary rounded-pill py-md-3 px-md-5 me-3 animated slideInLeft"><span style="color: rgb(255, 255, 255);">Visit Our Service MDU Page</span></a></div>
              <!-- End post content -->
