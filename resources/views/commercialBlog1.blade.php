    ...
    <p style="font-size: larger; color: #000000;">
      ...
      <p></p>
            ...
            <div class="content">
              ...
              <a style="margin-left: 30%;margin-top: 10%;" href="{{ route('commercial') }}"  class="btn btn-primary rounded-pill py-md-3 px-md-5 me-3 animated slideInLeft"><span style="color: rgb(255, 255, 255);">Visit Our Service Commercial Page</span></a>             </div><!-- End post content -->
